...
@section('content')
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<h1 class="to-animate">DGI-Consulting CMR </h1>
                            <h4 class="to-animate" style="color:white">(DIGITAL GROUP INTERNATIONAL LTD)</h4>
							<h2 class="to-animate">cabinet conseil en stratégie, organisation, management et formation.</h2>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row row-bottom-padded-sm">
				...
				<div class="col-md-4 col-sm-6 col-xxs-12">
					<a href="images/work_3.jpg" class="fh5co-project-item image-popup to-animate">
						<img src="{{ asset('images/work_3.jpg') }}" alt="Image" class="img-responsive">
						<div class="fh5co-text">
						<h2>Project 3</h2>
						<span>Web</span>
						</div>
			...
			<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="fh5co-counter to-animate">
						...
						<span class="fh5co-counter-label">Finished Nazir</span>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="fh5co-counter to-animate">
	...
	<section id="fh5co-contact" data-section="contact">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">DGI CONSULTING-AFRICA</h2>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h3>DGI Consulting est un cabinet conseil international en stratégie, organisation et management.</h3>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-6 to-animate">
					...
					<ul class="fh5co-contact-info">
						<li class="fh5co-contact-address ">
							<i class="icon-home"></i>
							DUPA LTD Velibaba MAH. YAKACIK CAD. N°132/1 A1<br>Block D.13PENDIK ISTANBUL
						</li>
						<li><i class="icon-phone"></i> + 33 (0)7 67 22 34 51</li>
						<li><i class="icon-envelope"></i>dgi-consulting@hotmail.com</li>
						<li><i class="icon-globe"></i> <a href="http://www.dgi-consulting.com" target="_blank">dgi-consulting.com</a></li>
					</ul>
				</div>
