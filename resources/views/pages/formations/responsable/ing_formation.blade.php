                ...
                <div class="col-md-4 col-xs-12 text-left">
                    ...
                    <div style="margin-left: 15px">
                        <p class="phone" style="font-size: 15px; color: whitesmoke">
                            <img src="{{ asset('public/icones/forward_16px.png') }}" alt="">  29 Janvier 2021
                        </p>
                        <p class="phone" style="font-size: 15px; margin-top:-15px; color: whitesmoke">
                            <img src="{{ asset('public/icones/forward_16px.png') }}" alt="">  30 Avril 2021
                        </p>
                        <p class="phone" style="font-size: 15px; margin-top:-15px; color: whitesmoke">
                            <img src="{{ asset('public/icones/forward_16px.png') }}" alt="">  10 Octobre 2021
                        </p>
                        <p class="phone" style="font-size: 15px; margin-top:-15px; color: whitesmoke">
                            <img src="{{ asset('public/icones/forward_16px.png') }}" alt="">  6 Décembre 2021
                        </p>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12 text-left">
