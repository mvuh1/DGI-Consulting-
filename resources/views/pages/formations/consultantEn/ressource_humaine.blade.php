    ...
    <div class="uk-section uk-section-default container mt-none mb-md">
        <div class="uk-container">
            ...
            <div class="uk-grid-match uk-child-width-1-1@m" uk-grid>
                <div>
                    <p>
                        La constance des turbulences économiques que traversent les entreprises impose au consultant
                        en ressources humaines de prendre une distance critique et à penser son métier d’une manière
                        radicalement nouvelle. Cette formation est une synthèse de ces réflexions qui débouchent sur
                        l’action stratégique possible. Il s’agit des fondements d’une nouvelle forme de consulting, créateur
                        de valeurs parce qu’en cohérence avec les enjeux économiques, sociétaux et technologiques qui
                        sont devenus ceux des entreprises. <br>
                        Un nouveau métier de consultant en ressources humaines qui accompagne l’entreprise et lui
                        insuffle la force pour se transformer. Alors que les acteurs de l’entreprise ont plus que jamais
                        besoin d'être accompagnés pour maîtriser et mettre en œuvre une stratégie du changement auquel
                        ils sont confrontés, le consultant en ressources humaines conçoit les dispositifs qui redonnent
                        une valeur nouvelle au capital humain, nourrit une relation durable avec les partenaires internes
                        ou externes, rend la transformation sociale possible et le changement humain acceptable.
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <p>
                    ...
                    Aux consultants en ressources humaines, cadres fonctionnels, managers en reconversion
                    professionnelle, responsables de formation, responsables en développement des compétences,
                    responsables des ressources humaines, conseillers en orientation, consultants d’entreprise ou
                    indépendants et à tous ceux et celles qui souhaitent créer, adapter, perfectionner ou développer
                    leurs compétences et faire évoluer leur expertise ou expérience professionnelle vers le métier de
            ...
            <div>
                ...
                <hr>
                <p>
                    Les objectifs de cette formation visent à maîtriser les mécanismes intellectuels et
                    méthodologiques qui permettent au stagiaire de passer d’une logique d'expert à une logique de
                    consultant en ressources humaines capable de concevoir, d'organiser, de piloter et d'animer un
                    processus de changement, d'orientation stratégique ou d'amélioration des pratiques du
                    management des ressources humaines dans l'entreprise :
                </p>
                <ul class="uk-list uk-list-square" style="margin-left: 20px">
                    <li>
                        Affirmer son leadership du consultant par la maîtrise des mécanismes permettant de passer
                        d'une logique de compétences professionnelles d'expert au métier de consultant en ressources
                        humaines.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        des outils pour concevoir des offres commerciales, réaliser les missions dans l’entreprise et
                        fidéliser le client
                    </li>
                    <li>
                    ...
                    <li>
                        Accompagner la mise en œuvre de la politique des ressources humaines, formaliser les
                        processus de transformation des relations sociales de l’entreprise en cohérence avec le modèle
                        stratégique de l’entreprise.
                    </li>
                    <li>
                        Piloter les projets du changement et de la transition, animer les équipes de pilotage en assurant
                        le suivi, l’évaluation et la pérennisation transformatrice du management des ressources
                        humaines dans l’entreprise
                    </li>
                    <li>
                        Déployer son projet professionnel du consultant en ressources humaines et valider le
                        positionnement de son cabinet de consultant en cohérence avec le capital de son expertise.
                    </li>
                </ul>
            </div>
                    ...
                    <div>
                        ...
                        <div id="module1" uk-modal>
                            <div class="uk-modal-dialog uk-modal-body">
                                <div>
                                    <h4> 
                                        Module 1: Affirmer son leadership du consultant en ressources humaines
                                    </h4>
                                    <ul class="uk-list uk-list-square" style="margin-left: 20px">
                                        <li>
                                            Les différents aspects du métier de consultant en ressources humaines et la polycompétence
                                            nécessaire pour assurer avec efficacité les missions qui lui sont confiées.
                                        </li>
                                        <li>
                                            Les grandes composantes du métier de consultant et les compétences nécessaires pour créer
                                            et développer son activité dans le cadre d'une charte éthique servant de référentiel à la culture
                                            du métier.
                                        </li>
                                        <li>
                                            L'analyse de son leadership de consultant en ressources humaines sur la base d’un référentiel
                                            des compétences relationnelles, méthodologiques, informationnelles et communicatives.
                                        </li>
                                        <li>
                                            Le discernement de son champ de performance optimale et de sa capacité à transmettre aux
                                            entreprises, ses connaissances, ses convictions et ses compétences opérationnelles.
                                        </li>
                                        <li>
                                            Le travail de mise en phase de son leadership avec le référentiel de compétences du consultant
                                            en ressources humaines et le synchroniser avec la spécificité de ses missions et les profils
                                            socioprofessionnels de ses clients.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            L'évaluation de cette séquence de formation s'opère par le biais de présentations des synthèses
                                            orales des stagiaires en mode individuel et en groupe. Les travaux de cette séquence de
                                            formation de consultant en ressources humaines sont réalisés avec l'aide de la pédagogie
                                            inductive et démonstrative. Elle s'appuie sur des outils tels que diagnostics, référentiels,
                                            questionnaires.
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div>
                        ...
                        <div id="module2" uk-modal>
                            <div class="uk-modal-dialog uk-modal-body">
                                <div>
                                    <h4> 
                                        Module 2: Définir la stratégie commerciale du consultant en ressources humaines
                                    </h4>
                                    <ul class="uk-list uk-list-square" style="margin-left: 20px">
                                        <li>
                                            La définition de la stratégie commerciale des prestations de conseil en ressources humaines et
                                            la mise en place d’un plan de marketing en cohérence avec les besoins des entreprises.
                                        </li>
                                        <li>
                                            Le positionnement de son activité de consultant en ressources humaines et la segmentation de
                                            la clientèle, interne et/ou externe à l’entreprise par type de prestations ou des offres de conseil.
                                        </li>
                                        <li>
                                            La conception d'une architecture numérique de présentation de son cabinet ou service et créer
                                            un dispositif des outils marketing, de documentation commerciale destinée aux clients et aux
                                            prospects cibles.
                                        </li>
                                        <li>
                                            Les outils de la connaissance du client pour décoder son profil socioprofessionnel et discerner
                                            avec précision ses besoins et attentes tangibles et intangibles de la part du consultant.
                                        </li>
                                        <li>
                                            L'élaboration des offres de conseil en ressources humaines, réaliser les plans d’action de
                    ...
                    <div>
                        ...
                        <div id="module3" uk-modal>
                            <div class="uk-modal-dialog uk-modal-body">
                                <div>
                                    <h4> 
                                        Module 3: Développer l'ingénierie de l'intervention de consultant
                                    </h4>
                                    <ul class="uk-list uk-list-square" style="margin-left: 20px">
                                        <li>
                                            L'appropriation de maniement des outils de réalisation des diagnostics du système de gestion
                                            des ressources humaines de l'entreprise sur la base des référentiels fonctionnels et
                                            formalisation des préconisations opérationnelles.
                                        </li>
                                        <li>
                                            Les techniques d'entretien de conseil pour appréhender les réalités du client, définir le
                                            processus de l'analyse de la demande et lancer la conception du pré-projet de conseil en
                                            ressources humaines.
                                        </li>
                                        <li>
                                            L'appropriation d'un dispositif complet d’ingénierie de consultant en management des projets,
                                            contenant les outils et les guides méthodologiques en interaction avec les technologies
                                            numériques.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            Les différentes méthodes de conception d’une intervention de conseil en management des
                                            projets et les facteurs clés de performance et contre-performance du consultant en
                                            intervention.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            Les conditions de réussite pour monter une structure de consultant en ressources humaines
                                            interne ou externe ayant pour objectif de servir d’accélérateur de la performance du système
                                            de gestion <strong>RH</strong> de l’entreprise.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div id="module4" uk-modal>
                            <div class="uk-modal-dialog uk-modal-body">
                                <div>
                                    ...
                                    <ul class="uk-list uk-list-square" style="margin-left: 20px">
                                        <li>
                                            L’appropriation des outils d’analyse du contexte d’entreprise et des liens fonctionnels entre
                                            les principaux acteurs d'entreprise, leur position dans l'organigramme et leurs interactions
                                        ...
                                        <li>
                                            ...
                                            intégration des critères d’une compétitivité basée sur l’effet d’expérience, de l'excellence des
                                            ressources humaines et/ou sur l’effet d’innovation.
                                        </li>
                                        <li>
                                            La vision stratégique sur la politique des ressources humaines qui permet d'éviter le risque de
                                            confusion ou d'interprétations aléatoires ou émotionnelles de la part des acteurs de
                                            l'entreprise.
                                        </li>
                                        <li>
                                            Les principes fondamentaux de la pensée et de l'action du management capables de
                                            transformer les contradictions et les conflits internes à l'entreprise en opportunités de
                                ...
                                <div>
                                    ...
                                    <ul class="uk-list uk-list-square" style="margin-left: 20px">
                                        <li>
                                            ...
                                            opportunités nouvelles et qui s’articulent avec les métiers stratégiques d'entreprise ainsi qu'avec
                                            les capacités humaines pour les optimiser.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            La formalisation des modèles de diagnostics stratégiques, s’appuyant sur les outils d’analyse et
                                            d'optimisation des indicateurs de performances économiques, technologiques, humaines,
                                            financières de l’entreprise.
                                        </li>
                                        <li>
                                            Les méthodes pour utiliser les pressions et risques externes, constituant la menace pour
                                            l'entreprise, comme un levier du changement et les contradictions internes comme dynamique
                                            d’action pour donner sens à l’action stratégique.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            Les méthodes d’intégration de nouvelles valeurs et de nouvelles compétences fondées sur les
                                            référentiels de dix rôles de management servant de levier dans la stratégie d'entreprise
                                            compétitive.
                                        </li>
                                        <li>
                                            Les six règles de management pour créer la synergie fonctionnelle et la cohésion des équipes,
                                            qui apportent à toute la ligne hiérarchique la posture professionnelle et les compétences qui
                                            vont légitimer l’action stratégique.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <ul class="uk-list uk-list-square" style="margin-left: 20px">
                                        <li>
                                            ...
                                            les plans d'action stratégique et enclencher le processus réflexif sur le processus du
                                            changement.
                                        </li>
                                        <li>
                                            La définition des modalités de mobilisation différentiée, selon le profil socioprofessionnel des
                                            acteurs, à l’adhésion au projet comme un moyen pour faire progresser son métier, son
                                            entreprise, ses clients.
                                        </li>
                                        <li>
                                            Le mode clarification des critères de différenciation entre la stratégie, la conduite du
                                            changement et de la transition que chaque acteur de l’entreprise doit traverser de façon
                                            autonome, mais en cohésion avec l’action commune.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            La formulation des objectifs de formation des salariés impactés par le changement en précisant
                                        ...
                                        <li>
                                            ...
                                            transition et ses résonances en tant que facteur de réussite de la stratégie du changement dans
                                            le périmètre de la direction des ressources humaines.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div id="module7" uk-modal>
                            <div class="uk-modal-dialog uk-modal-body">
                                <div>
                                    <h4> 
                                        Module 7: Déployer son projet professionnel du consultant en RH
                                    </h4>
                                    <ul class="uk-list uk-list-square" style="margin-left: 20px">
                                        <li>
                ...
                <div class="col-md-4 col-xs-12 text-left">
                    ...
                    <div style="margin-left: 15px">
                        <p class="phone" style="font-size: 15px; color: whitesmoke">
                            <img src="{{ asset('icones/forward_16px.png') }}" alt="">  9 Février 2021
                        </p>
                        <p class="phone" style="font-size: 15px; margin-top:-15px; color: whitesmoke">
                            <img src="{{ asset('icones/forward_16px.png') }}" alt="">  13 Mai 2021
                        </p>
                        <p class="phone" style="font-size: 15px; margin-top:-15px; color: whitesmoke">
                            <img src="{{ asset('icones/forward_16px.png') }}" alt="">  14 Septembre 2021
                        </p>
                        <p class="phone" style="font-size: 15px; margin-top:-15px; color: whitesmoke">
                            <img src="{{ asset('icones/forward_16px.png') }}" alt="">  17 Décembre 2021
                        </p>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12 text-left">
