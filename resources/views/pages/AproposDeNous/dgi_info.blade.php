    ...
    <div class="uk-section uk-section-default container mt-none mb-md">
        <div class="uk-container">
            ...
            <div class="uk-grid-match uk-child-width-1-3@m" uk-grid>
                <div>
                    <ul class="uk-list">
                        <li><h4> <img src="{{asset('icones/flecheDroit.png')}}" alt="fleche"> Direction Commerciale</h4></li>
                ...
                <div>
                    <ul class="uk-list">
                        <li><h4> <img src="{{asset('icones/flecheDroit.png')}}" alt="fleche"> Conseillers Formation</h4></li>
                ...
                <div>
                    <ul class="uk-list">
                        <li><h4> <img src="{{asset('icones/flecheDroit.png')}}" alt="fleche"> Accueil</h4></li>
                ...
                <div>
                    <ul class="uk-list">
                        <li><h4> <img src="{{asset('icones/flecheDroit.png')}}" alt="fleche"> Comptabilité</h4></li>
